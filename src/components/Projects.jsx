...
const projectsData = [
  ...
  {
    title: "Naná",
    description: "Savor authentic Italian cuisine at Naná, a React and Vanilla CSS creation embodying a true Italian restaurant experience in Frankfurt.",
    image: Nana,
...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-16 md:py-28 bg-background bg-gradient-to-bl from-primary/5 to-secondary/10 backdrop-blur-sm" ref={sectionRef}>
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl font-bold text-center mb-12 bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary">My Projects</h2>
        </motion.div>
